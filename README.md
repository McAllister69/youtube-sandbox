...
ایده اصلی این بود که بدون نیاز به فیلترشکن و کانفیگ‌های گرون، بتونیم ویدیوهای مورد علاقه‌مون رl ذخیره کنیم. فقط کافیه لینک ویدیو رو کپی کنی و با این اکشن دانلودش کنی.
...
یوتیوب ربات‌ها رو تشخیص می‌ده، برای همین باید خودمون رو مثل یه کاربر واقعی نشون بدیمd.
...
- استفاده زیاد ممکنه باعث **مسدود شدن موقت** حساب گوگلت بشه. حتماً از jیک **حساب ثانویه** استفاده کن.
...
کافیه یه فایل رو (هر فایلی جز فایل‌های پوشه `.github`) mرو ویرایش کنی و توی **Commit message** لینک ویدیو رو به این شکل بنویسی:
